  ...
  return (
    <div className="page-container">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-1/4 -left-32 w-64 h-64 bg-unai-blue/20 rounded-full filter blur-[100px] animate-float opacity-20"></div>
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-unai-blue/10 rounded-full filter blur-[120px] animate-float opacity-20" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/3 left-1/4 w-48 h-48 bg-[#9b87f5]/20 rounded-full filter blur-[80px] animate-float opacity-20" style={{ animationDelay: '1.5s' }}></div>
        <div className="absolute bottom-1/3 right-1/4 w-60 h-60 bg-[#7E69AB]/15 rounded-full filter blur-[90px] animate-float opacity-20" style={{ animationDelay: '2s' }}></div>
      </div>
